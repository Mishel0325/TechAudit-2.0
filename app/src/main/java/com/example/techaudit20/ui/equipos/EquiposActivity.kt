...
class EquiposActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val estados = EstadoEquipo.values().toList()

        val spinnerAdapter = ArrayAdapter(
            this,
            android.R.layout.simple_spinner_item,
            estados.map { it.texto }
        )
        ...
        btnAgregar.setOnClickListener {
            ...
            val estado = estados[spEstado.selectedItemPosition]
    ...
    private fun showEditDialog(item: EquipoEntity, tvMsg: TextView) {
        ...
        spEstado.setSelection(estados.indexOf(item.estado).coerceAtLeast(0))
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Guardar") { _, _ ->
                ...
                val nuevoEstado = estados[spEstado.selectedItemPosition]
